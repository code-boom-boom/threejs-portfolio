...
export default class Camera {
  ...
  setInstance() {
    ...
    this.time.on('tick', () => {
      if (!this.orbitControls.enabled) {
        ...
        this.targetEased.z += (this.target.x - this.targetEased.z) * this.easing
  ...
  setPan() {
    ...
    this.pan.hitMesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(500, 500, 1, 1), new THREE.MeshBasicMaterial({
      color: 0xff0000,
      wireframe: true,
      visible: false,
    }))
